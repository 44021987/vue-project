  ...
  <div class="user_wrapper" v-loading="loading" v-if="!loading">
    <div class="user_author">
      ...
      <div>
        ...
        <h5>
          <i class="fa fa-thumbs-up"></i>&nbsp; {{userInfo.score}}</h5>
        <h5>
          <i class="fa fa-github"></i>&nbsp;
          <a :href="'https://github.com/'+userInfo.githubUsername">https://github.com/{{userInfo.githubUsername}}</a>
        </h5>
        <h5>
          <i class="fa fa-calendar"></i>&nbsp; {{String(userInfo.create_at).match(/.{10}/)[0]}}</h5>
      </div>
    </div>
